<div id="content">
    <!-- BEGIN TABLE HOVER -->
    <span id="linkToGetElement" class="hidden">ajax/AddDelivrer.php</span>
    <section class="">
        ...
        <div class="section-body col-md-9 content-section-center offset-sm-2">
            <form class="form delivrer_add_form with_date" enctype="multipart/form-data">
                <em class="text-caption">(*) Champs obligatoires. </em>
                        <div class="card">
                            <div class="card-head card-head-xs style-primary">
                                <header>
                                    <h2 class="text-default-bright">Formulaire d'ajout de Livreurs</h2>
                                </header>
                                ...
                                <div class="row">                                    
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <input type="text" name="name_delivrer" class="form-control" id="name_delivrer" required>
                                            <label for="name_delivrer">Nom*</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <input type="text" name="lastname_delivrer" class="form-control" id="lastname_delivrer" required>
