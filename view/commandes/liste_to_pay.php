        ...
        <div class="section-body">
                        ...
                        <div class="card-body no-padding">
                            <div class="col-sm-12 alert alert-callout alert-warning no-margin">
                                <div class="col-sm-12  text-center">
                                    <span class="data-title">en attente de paiement</span>
                                </div>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="card">
                        <div class="card-body no-padding">
                            <div class="col-sm-12 alert alert-callout alert-warning no-margin">
                                <div class="col-sm-12  text-center">
                                    <span class="data-title">payer partiellement</span>
                                </div>
                                <div class="col-sm-9 float-left no-padding">
                                    <strong class="text-lg stat-data-value total_cmd_pending_montant">
                                        <?php echo  number_format($total_cmd_partial['montant'], 0, '', ' '); ?>
                                    </strong><br/>
                                    <span class="opacity-50">Montant</span>
                                </div>
                                <div class="col-sm-3 float-right no-padding">
                                    <strong class="text-lg stat-data-value total_cmd_pending_nbre">
                                        <?php echo  number_format($total_cmd_partial['nbre'], 0, '', ' '); ?>
                                    </strong><br/>
                                    <span class="opacity-50">Nombre</span>
                                </div>                                
                            </div>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="card">
                        <div class="card-body no-padding">
                            <div class="col-sm-12 alert alert-callout alert-warning no-margin">
                                <div class="col-sm-12  text-center">
                                    <span class="data-title">payer à crédit</span>
                                </div>
                                <div class="col-sm-9 float-left no-padding">
                                    <strong class="text-lg stat-data-value total_cmd_pending_montant">
                                        <?php echo  number_format($total_cmd_credit['montant'], 0, '', ' '); ?>
                                    </strong><br/>
                                    <span class="opacity-50">Montant</span>
                                </div>
                                <div class="col-sm-3 float-right no-padding">
                                    <strong class="text-lg stat-data-value total_cmd_pending_nbre">
                                        <?php echo  number_format($total_cmd_credit['nbre'], 0, '', ' '); ?>
                                    </strong><br/>
                                    <span class="opacity-50">Nombre</span>
                                </div>                                
                            </div>
                ...
                <div class="card">
                    <div class="card-head card-head-xs style-primary">
                        ...
                        <div class="tools">
                            ...
                            data-original-title="Annuler le filtre" href="<?php echo BASE_URL.DS.'commandes/liste_to_validation'; ?>">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group ">
                                    <select id="select2" name="status" class="form-control dirty selectpicker" data-live-search="true">
                                        <option value="" >&nbsp;</option>
                                        <option value="7">EN ATTENTE DE PAIEMENT</option>
                                        <option value="8">PAYER PARTIELLEMENT</option>
                                        <option value="5">PAYER A CREDIT</option>
                                    </select>
            ...
            <div class="card">
                <div class="card-head card-head-xs style-primary list-element">
                    <header>
                        <h2 class="text-default-bright">Liste des commandes à valider</h2>
                    </header>
                    <div class="tools">
                        <a id="extract-excel-btn" class="btn btn-icon-toggle " data-toggle="tooltip" data-placement="left"
                        href="<?php echo SITE_BASE_URL.'commandes/extraction/start_date&'.$order_first->date_first.'/start_hour&00:00:00/end_date&'.date("Y-m-d").'/end_hour&23:59:59/tel_user&/client_id&/cmd_amount&/cmd_id&/status&0'; ?>" 
                  ...
                  <div class="table-responsive">
                      ...
                      <table id="order-list" class="table table-hover " 
                        ...
                        >
                            ...
                            <tbody>
                                <?php $nbre_cmd_plus = $total_cmd_pending['nbre']; ?>
                                    ...
                                    <tr class="<?php echo $commande->cmd_id; ?>">
                                        ...
                                        <td class="text-right">
                                            <button type="button" class="btn btn-icon-toggle check-details-btn" data-toggle="tooltip" cmd-id="<?php echo $commande->cmd_id; ?>"
                                                data-placement="top" data-original-title="Effectuement un paiment">
                                                <a href="<?php echo BASE_URL.DS.'commandes/pay/'.$commande->cmd_id; ?>">
                                                    <i class="fa fa-money"></i>
                                                </a>
                                            </button>
                                            <button type="button" class="btn btn-icon-toggle check-details-btn" data-toggle="tooltip" cmd-id="<?php echo $commande->cmd_id; ?>"
                                                data-placement="top" data-original-title="Voir la liste des versements">
                                                <a href="<?php echo BASE_URL.DS.'commandes/liste_versements/'.$commande->cmd_id; ?>">
