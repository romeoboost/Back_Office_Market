<div id="content">
    ...
    <section class="">
        ...
        <div class="section-body">
            ...
            <form class="form quick_cmd_search_form with_date">
                        ...
                        <div class="card">
                            <div class="card-head card-head-xs style-primary">
                                ...
                                <div class="tools">
                                    ...
                                    data-original-title="Annuler le filtre" href="<?php echo BASE_URL.DS.'commandesRapide/liste'; ?>">
    ...
    href="<?php echo SITE_BASE_URL.'commandesRapide/extraction/start_date&'.$order_first->date_first.'/start_hour&00:00:00/end_date&'.date("Y-m-d").'/end_hour&23:59:59/tel_user&/client_id&/cmd_amount&/cmd_id&/status&'; ?>" 
                ...
                <div class="card-body">
                  <div class="table-responsive">
                      ...
                      <table id="order-list" class="table table-hover quick-order-list" 
                                    ...
                                    <tr class="<?php echo $commande->cmd_id; ?>">
                                        ...
                                        <td class="text-right">
                                            ...
                                            <?php if( $commande->cmd_statut == 3 ): ?>
                                                <button type="button" class="btn btn-icon-toggle set-confirm-shipping-btn quick-order" data-toggle="tooltip" cmd-id="<?php echo $commande->cmd_id; ?>"
                                            ...
                                            <?php if( $commande->cmd_statut == 4 ): ?>
                                                <button type="button" class="btn btn-icon-toggle set-restore-btn quick-order" data-toggle="tooltip" cmd-id="<?php echo $commande->cmd_id; ?>"
                                            ...
                                            <button type="button" class="btn btn-icon-toggle check-details-btn" data-toggle="tooltip" cmd-id="<?php echo $commande->cmd_id; ?>"
                                                ...
                                                <a href="<?php echo BASE_URL.DS.'commandesRapide/details/'.$commande->cmd_id; ?>">
...
<div class="modal own-modal fade" id="modal-set-shipping" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form id="form-set-shipping" class="form quick-order">
      <div class="modal-body order-confirmation-body">
        <div class="row">
            <div class="card-body ">
                                <!-- floating-label -->
                <div id="" class="col-md-12 text-center errorForm"></div>
                <em class="text-caption">Prière renseigner les champs "Montant De commande" et "Choisir le livreur".</em>
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <input type="text" name="cmd_montant_ht" class="form-control">
                            <label for="cmd_montant_ht"> Montant De commande </label>
                        </div>
                    </div> 
                    <div class="col-sm-6">
                        <div class="form-group">
...
<div class="modal own-modal fade" id="modal-set-stop-shipping" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form id="form-set-stop-shipping" class="form quick-order">
      <div class="modal-body order-confirmation-body">
        <div class="row">
            <div class="card-body ">
                                <!-- floating-label -->
...
<div class="modal own-modal fade" id="modal-delete-order" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form id="form-delete-order" class="form quick-order">
      <div class="modal-body order-confirmation-body">
        <div class="row">
...
<div class="modal own-modal fade" id="modal-reject-order" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form id="form-reject-order" class="form quick-order">
      <div class="modal-body order-confirmation-body">
        <div class="row">
            <!-- <div id="" class="col-md-12 text-center">
                <em class="text-caption">
