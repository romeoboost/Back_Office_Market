<div id="content">
    ...
    <section class="">
        ...
        <div class="section-body">
                            ...
                            <div class="col-sm-12 alert alert-callout alert-info no-margin">
                                ...
                                <div class="col-sm-12 text-center no-padding">
                                    <strong class="text-xl stat-data-value no-padding total">
                                       <?php echo number_format($fournisseurs['total']['nbre'], 0, '', ' '); ?>
            ...
            <form class="form fournisseurs_search_form with_date">
                        ...
                        <div class="card">
                            <div class="card-head card-head-xs style-primary">
                                ...
                                <div class="tools">
                                    ...
                                    data-original-title="Annuler le filtre" href="<?php echo SITE_BASE_URL.'fournisseurs/liste'; ?>">
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <label for="name_supplier">Nom du fournisseur</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
            ...
            <div class="card">
                <div class="card-head card-head-xs style-primary list-element">
                    <header>
                        <h2 class="text-default-bright">Liste des Fournisseurs</h2>
                        <!-- <p>
                    ...
                    <div class="tools">
                        <a id="add-element-btn" class="btn btn-icon-toggle " data-toggle="tooltip" data-placement="left"
                            href="<?php echo SITE_BASE_URL.'fournisseurs/ajouter'; ?>" 
                             data-original-title="Ajouter une nouveau fournisseurs">
                            <i class="fa fa-plus-square"></i>
                        </a>

                        <a id="extract-excel-btn" class="btn btn-icon-toggle " data-toggle="tooltip" data-placement="left"
    href="<?php echo SITE_BASE_URL.'fournisseurs/extraction/start_date&2018-01-01/start_hour&00:00:00/end_date&'.date("Y-m-d").'/end_hour&23:59:59/name_supplier&/tel&'; ?>" 
                ...
                <div class="card-body">
                  <div class="table-responsive">
                      ...
                      <table id="fournisseurs-list" class="table table-hover" 
                        ...
                        >
                            ...
                            <tbody>
                                ...
                                <?php $nbre_cmd_plus = $fournisseurs['total']['nbre']; ?>
                                <?php if( !empty( $fournisseurs['liste'] ) ): ?>
                                <?php foreach ( $fournisseurs['liste'] as $fournisseur ): ?>
                                <tr class="text-center <?php echo $fournisseur->token; ?>">
                                    <td><?php echo $nbre_cmd_plus--; ?></td>
                                    <td class="token" ><?php echo $fournisseur->token; ?> </td>
                                    <td class="name_supplier" ><?php echo ucfirst( $fournisseur->nom ); ?></td>
                                    <td> <?php echo $fournisseur->tel; ?> </td>
                                    <td> <?php echo $fournisseur->email; ?> </td>
                                    <td><?php echo dateFormat($fournisseur->date_creation); ?></td>
                                    <td><?php echo dateFormat($fournisseur->date_modification); ?></td>
                                    <td class="">
                                        <button type="button" class="btn btn-icon-toggle" data-toggle="tooltip" data-placement="top" fournisseurs-id="<?php echo $fournisseur->token; ?>"
                                         data-original-title="Modifier les informations du produit">
                                            <a href="<?php echo BASE_URL.DS.'fournisseurs/modifier/'.$fournisseur->token; ?>">
                                                    <i class="fa fa-pencil"></i>
                                            </a>
                                        </button>
                                        <button type="button" class="btn btn-icon-toggle" data-toggle="tooltip" data-placement="top" fournisseurs-id="<?php echo $fournisseur->token; ?>"
                                         data-original-title="Voir les détails du produit">
                                            <a href="<?php echo BASE_URL.DS.'fournisseurs/details/'.$fournisseur->token; ?>">
                                                    <i class="md md-description"></i>
                                            </a>
                                        </button>
                                        <button type="button" class="btn delete-btn btn-icon-toggle" data-toggle="tooltip" data-placement="top" fournisseurs-id="<?php echo $fournisseur->token; ?>"
                      ...
                      <div class="col-sm-12 text-center">
                            <ul id="list-fournisseurs-pagination" class="pagination ">
...
<div class="modal own-modal fade" id="modal-delete-fournisseurs" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title text-uppercase" id="exampleModalLongTitle"> SUPPRIMER LE FOURNISSEUR </h4>
      </div>
      <form id="form-delete-fournisseurs" class="form">
      <div class="modal-body order-confirmation-body">
        <div class="row">
            <div id="" class="col-md-12 text-center">
                <em class="text-caption">
                    (*) Champs obligatoires. On ne peut supprimer les fournisseurs déjà liés à une ligne de stock.
                </em><br>
            </div>    
            <div class="card-body ">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            <input type="text" name="name_supplier" class="form-control"  disabled>
                            <label for="name_supplier"> Nom de la Catégorie </label>
                        </div>
                    </div> 
                </div>
                <div class="row">
