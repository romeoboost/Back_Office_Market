<div id="content">
    ...
    <section class="">
        ...
        <div class="section-body col-md-9 content-section-center offset-sm-2">
            <form class="form supplier_update_form with_date" enctype="multipart/form-data">
                <em class="text-caption">(*) Champs obligatoires. </em>
                        <div class="card">
                            <div class="card-head card-head-xs style-primary">
                                <header>
                                    <h2 class="text-default-bright">Formulaire de Modification de Fournisseur</h2>
                                </header>
                                ...
                                <div class="row">                                    
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            value="<?php echo $fournisseur->nom; ?>" required>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            value="<?php echo $fournisseur->tel; ?>" required>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            value="<?php echo $fournisseur->email; ?>" id="email" >
                                            <label for="email">Email</label>
                                        </div>
                                    </div>
                                </div>
                                <input type="hidden" name="token" class="form-control" value="<?php echo $fournisseur->token; ?>">
