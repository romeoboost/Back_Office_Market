<div id="content">
    <!-- BEGIN TABLE HOVER -->
    <span id="linkToGetElement" class="hidden">ajax/UpdateDelivrer.php</span>
    <section class="">
        ...
        <div class="section-body col-md-9 content-section-center offset-sm-2">
            <form class="form delivrer_update_form with_date" enctype="multipart/form-data">
                <em class="text-caption">(*) Champs obligatoires. </em>
                        <div class="card">
                            <div class="card-head card-head-xs style-primary">
                                <header>
                                    <h2 class="text-default-bright">Formulaire de Modification de Livreur</h2>
                                </header>

                                <div class="tools">
                                    <a class="btn btn-icon-toggle" data-toggle="tooltip" data-placement="left" 
                                    data-original-title="Revenir à la liste des catégories" 
                                    href="<?php echo SITE_BASE_URL.'livreurs/liste'; ?>">
                                ...
                                <div class="row">                                    
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            value="<?php echo $livreur->nom; ?>" required>
                                            <label for="name_delivrer">Nom*</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <input type="text" name="lastname_delivrer" class="form-control" id="lastname_delivrer" 
                                            value="<?php echo $livreur->prenoms; ?>" required>
                                            <label for="lastname_delivrer">Prenoms*</label>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            value="<?php echo $livreur->tel; ?>" required>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            value="<?php echo $livreur->email; ?>" id="email" >
                                            <label for="email">Email</label>
                                        </div>
                                    </div>
                                </div>
                                <input type="hidden" name="token" class="form-control" value="<?php echo $livreur->token; ?>">
