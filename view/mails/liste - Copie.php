<div id="content">
    ...
    <span id="linkToGetElement" class="hidden">ajax/SearchMails.php</span>
    <span id="linkSetHomeElement" class="hidden">ajax/UpdateSetHomeMails.php</span>
    <section class="">
        ...
        <div class="section-body">
            ...
            <form class="form mails_search_form with_date">
                        ...
                        <div class="card">
                            <div class="card-head card-head-xs style-primary">
                                ...
                                <div class="tools">
                                    ...
                                    data-original-title="Annuler le filtre" href="<?php echo SITE_BASE_URL.'mails/liste'; ?>">
            ...
            <div class="card">
                <div class="card-head card-head-xs style-primary list-element">
                    <header>
                        <h2 class="text-default-bright">Liste des Mails</h2>
                        <!-- <p>
    ...
    href="<?php echo SITE_BASE_URL.'pubs/extraction/start_date&2018-01-01/start_hour&00:00:00/end_date&'.date("Y-m-d").'/end_hour&23:59:59/name_cotegory&/status_cotegory&'; ?>" 
                ...
                <div class="card-body">
                  <div class="table-responsive">
                      ...
                      <table id="mails-list" class="table table-hover" 
                        ...
                        >
                            ...
                            <tbody>
                                ...
                                <tr class="text-center <?php echo $element->token; ?>">
                                    ...
                                    <td class="objet" ><?php echo $element->objet; ?></td>
                                    <td class="contenu" >
                                    ...
                                    <td class="">
                                        ...
                                        <button type="button" class="btn btn-icon-toggle response-btn" data-toggle="tooltip" data-placement="top" 
                                            element-id="<?php echo $element->token; ?>" data-original-title="Repondre au mail">
                                            <a href="<?php echo BASE_URL.DS.'mails/repondre/'.$element->token; ?>">
                                        ...
                                        <button type="button" class="btn btn-icon-toggle detail-element-btn " data-toggle="tooltip" data-placement="top"
                                                category-id="<?php echo $element->token; ?>" data-original-title="Voir les détails des échanges">
                                            <a href="<?php echo BASE_URL.DS.'mails/details/'.$element->token; ?>">
                      ...
                      <div class="col-sm-12 text-center">
                            <ul id="list-mails-pagination" class="pagination ">
