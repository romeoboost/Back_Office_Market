                ...
                <div class="card-head card-head-xs style-primary list-element">
                    ...
                    <div class="tools">
                        <a id="extract-excel-btn" class="btn btn-icon-toggle " data-toggle="tooltip" data-placement="left"
                            ...
                            target="_blank" data-original-title="Ajouter un nouveau produit">
                            <i class="fa fa-plus-square"></i>
                        </a>
                        <a id="extract-excel-btn" class="btn btn-icon-toggle " data-toggle="tooltip" data-placement="left"
    href="<?php echo SITE_BASE_URL.'produits/extraction/start_date&2019-01-01/start_hour&00:00:00/end_date&'.date("Y-m-d").'/end_hour&23:59:59/name_product&/category_product&/stock_product&/unit_mesure&/status_product&/promo_product&/amount_product&'; ?>" 
                        ...
                        >
                            ...
                            <tbody>
                                ...
                                <tr class="<?php echo $produit->token_produit.' '.color_ligne_product($produit); ?>">
                                    ...
                                    <td><?php echo ucfirst( $produit->nom_produit ); ?></td>
                                    <td><?php echo ucfirst( $produit->categorie ); ?></td>
                                    <td><?php echo number_format($produit->stock, 0, '', ' '); ?></td>
