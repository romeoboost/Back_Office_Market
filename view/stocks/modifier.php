    ...
    <section class="">
        <div class="section-header">
            <ol class="breadcrumb">
                ...
                <li class="active"><?php echo $stock->stock_id; ?>/</li>
            </ol>
        </div>
        <div class="row align-items-center" >
        <div class="section-body col-md-9 content-section-center offset-sm-2">
            <form class="form stocks_update_form with_date" enctype="multipart/form-data">
                <em class="text-caption">(*) Champs obligatoires. </em>
                        <div class="card">
                            <div class="card-head card-head-xs style-primary">
                                <header>
                                    <h2 class="text-default-bright">Formulaire de modification de stock</h2>
                                </header>
                            ...
                            <div class="card-body ">
                                            ...
                                            data-live-search="true">
                                                ...
                                                <?php foreach ( $produits as $produit ): ?>
                                                    <option class="toUpCase" value="<?php echo  $produit->id ?>"
                                                        <?php echo ( $produit->id == $stock->id_produit ) ? 'selected' : ''; ?>
                                                        >
                                            ...
                                            data-live-search="true">
                                                ...
                                                <?php foreach ( $fournisseurs as $fournisseur ): ?>
                                                    <option class="toUpCase" value="<?php echo  $fournisseur->id ?>"
                                                        <?php echo ( $fournisseur->id == $stock->id_fournisseur ) ? 'selected' : ''; ?>
                                                        >
                                ...
                                <div class="row">                                    
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <input type="number" name="qtte" class="form-control" id="qtte" value="<?php echo  $stock->qtte ?>" required>
                                            <input type="hidden" name="old_qtte" value="<?php echo  $stock->qtte ?>">
                                            <label for="qtte"> Quantité *</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <input type="number" name="montant" class="form-control" id="montant" value="<?php echo $stock->montant_ht ?>"  required>
                                ...
                                <div class="row">                                    
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <input type="number" name="frais" class="form-control" id="frais" value="<?php echo $stock->frais_livraison ?>"  required value="0">
                                            <label for="frais"> Frais *</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <input type="number" name="montant_ttc" class="form-control" id="montant_ttc" value="<?php echo $stock->montant_total ?>" required>
                                            <label for="montant_ttc">  Montant Total*</label>
                                        </div>
                                    </div>
                                </div>

                                <input type="hidden" name="token" value="<?php echo  $stock->stock_id ?>">
