    ...
    if( empty($commande) ){ 
      ...
      if( $commande->statut != 3 ){
        ...
        $error_text_second = "Cette commande ne peut être modifiée. Statut incorrect.";
          ...
          $update_req = $pdo->prepare("UPDATE commandes SET statut = :statut, id_utilisateur = :id_utilisateur, date_modification = :date_modification, date_livraison = :date_livraison
                                                 WHERE token = :token "); 
